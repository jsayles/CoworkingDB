# Generated by Django 3.0.2 on 2020-01-28 22:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('founder', 'Founder'), ('owner', 'Owner'), ('employee', 'Employee'), ('member', 'Member'), ('volunteer', 'Volunteer'), ('worktrade', 'Work Trade'), ('board', 'Board Member'), ('vendor', 'Product Vendor'), ('consultant', 'Consultant'), ('other', 'Other')], default='other', max_length=16)),
        ...
        migrations.AddField(
            model_name='person',
            name='location',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='crdb.Location'),
        ),
        migrations.AddField(
            model_name='person',
